...
extern const uint8_t BMP13[];//笑
extern const uint8_t BMP14[];//kk
extern const uint8_t BMP15[];//loog
extern const uint8_t BMP16[];//欢迎
//动画
extern const uint8_t gImage_1[];
extern const uint8_t gImage_2[];
extern const uint8_t gImage_3[];
extern const uint8_t gImage_4[];
extern const uint8_t gImage_5[];
extern const uint8_t gImage_6[];
extern const uint8_t gImage_7[];
extern const uint8_t gImage_8[];
extern const uint8_t gImage_9[];
extern const uint8_t gImage_10[];
